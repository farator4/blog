		...
		if (count($the404s)) {
			...
			foreach ($the404s as $url => $data) {
				...
				$this->table_cells(array(
					...
					, 'referers' => number_format_i18n(count($data['referers'])) . (count($data['referers']) ? " <a href='#' class='su_toggle_hide' data-toggle='su-404s-hit-$md5url-referers'><img src='{$this->module_dir_url}hit-details.png' title='".__('View list of referring URLs', 'seo-wizard')."' /></a>" : '')
					, 'user-agents' => number_format_i18n(count($data['user_agents'])) . (count($data['user_agents']) ? " <a href='#' class='su_toggle_hide' data-toggle='su-404s-hit-$md5url-user-agents'><img src='{$this->module_dir_url}hit-details.png' title='".__('View list of user agents', 'seo-wizard')."' /></a>" : '')
				));
				...
				if (count($data['referers'])) {
					...
					echo "<a href='#' class='su_toggle_up' data-toggle='su-404s-hit-$md5url-referers'>".__('Hide list', 'seo-wizard')."</a>";
					echo "</div>\n";
					echo "\t\t\t<ul>\n";
				...
				if (count($data['user_agents'])) {
					...
					echo "<a href='#' class='su_toggle_up' data-toggle='su-404s-hit-$md5url-user-agents'>".__('Hide list', 'seo-wizard')."</a>";
					echo "</div>\n";
					echo "\t\t\t<ul>\n";
