...
class SU_Fofs extends SU_Module {
	static function get_module_title() { return __('404 Monitor', 'seo-wizard'); }
    function get_menu_title() { return __('404 Monitor', 'seo-wizard'); }
...
", 'seo-wizard')));
		...
		$screen->add_help_tab(array(
			  'id' => 'su-fofs-settings'
			, 'title' => __('Settings Help', 'seo-wizard')
			, 'content' => __("
